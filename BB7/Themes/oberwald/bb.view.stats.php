...
<?php get_header(); ?>
	<?php if (have_posts()) : ?>
		...
		<div id="breadcrumb">
			<p><a href="<?php echo get_option('home'); ?>" title="Back to the front of the BBBBL">BBBBL</a> &raquo; <?php the_title(); ?></p>
		</div>
			<div class="entry">
				<h2><?php the_title(); ?></h2>
...
?>
				...
				<p>Since the <strong>BBBBL's</strong> inception, <strong><?php print($playernum); ?></strong> Players in <strong><?php print($teamnum); ?></strong> Teams have played <strong><?php print($matchnum); ?></strong> Matches in <strong><?php print($compnum); ?></strong> Competitions for <strong><?php print($cupnum); ?></strong> Championship Cups over <strong><?php print($seanum); ?></strong> Seasons. In total they have managed to:</p>
				<ul>
...
<!--						<li><a href="<?php echo get_option('home'); ?>/stats/milestones/" title="View the BBBBL Milestones">Milestones</a></li> -->
					</ol>
				</div>
...
<?php
				...
				print("<h4>Top Players (All Time)</h4>\n	<p>Players who are <strong>highlighted</strong> are still active in the BBBBL.</p>\n");
				if ($topstats = $wpdb->get_results($statsql)) {
					print("<table class=\"expandable\">\n	<tr>\n		<th class=\"tbl_stat\">#</th>\n		<th class=\"tbl_name\">Player</th>\n		<th>Position</th>\n		<th class=\"tbl_name\">Team</th>\n		<th class=\"tbl_stat\">SPP</th>\n		</tr>\n");
					$zebracount = 1;
					$prevvalue = 0;
