<?php
	...
	<?php if (have_posts()) : ?>
		...
		<div id="breadcrumb">
			<p><a href="<?php echo get_option('home'); ?>" title="Back to the front of the BBBBL">BBBBL</a> &raquo; <a href="<?php echo get_option('home'); ?>/warzone/" title="Back to the BBBBL Warzone">Warzone</a> &raquo; <?php the_title(); ?></p>
		</div>
	...
	<div id="subcontent">
		<ul>
			<li><h2>About the Warzone</h2>
				<p>The Warzone is the BBBBL's source for the latest team news a gossip. It presents a weekly update on the league and its happenings.</p>
