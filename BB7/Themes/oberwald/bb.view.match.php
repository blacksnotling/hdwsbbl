...
<?php get_header(); ?>
	<?php if (have_posts()) : ?>
		...
		<div id="breadcrumb">
			<p><a href="<?php echo get_option('home'); ?>" title="Back to the front of the BBBBL">BBBBL</a> &raquo; <a href="<?php echo get_option('home'); ?>/matches/" title="Back to the result listing">Results</a> &raquo; <?php the_title(); ?></p>
		</div>
			<div class="entry">
