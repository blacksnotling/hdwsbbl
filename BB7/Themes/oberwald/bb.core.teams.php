...
20080419 - 0.2a - changed the sql so only BBBBL teams are shown.
...
20090330 - 1,2 - Editied to filter out non BBBBL details
...
<?php get_header(); ?>
	<?php if (have_posts()) : ?>
		...
		<div id="breadcrumb">
			<p><a href="<?php echo get_option('home'); ?>" title="Back to the front of the BBBBL">BBBBL</a> &raquo; Teams</p>
		</div>
			<div class="entry">
				<h2><?php the_title(); ?></h2>
