...
<?php get_header(); ?>
	<?php if (have_posts()) : ?>
		...
		<div id="breadcrumb">
			<p><a href="<?php echo get_option('home'); ?>" title="Back to the front of the BBBBL">BBBBL</a> &raquo; <a href="<?php echo get_option('home'); ?>/teams/" title="Back to the team listing">Teams</a> &raquo; <a href="<?php echo get_option('home'); ?>/star-players/" title="See more Star Players">Star Players</a> &raquo; <?php the_title(); ?></p>
		</div>
		<?php
			/*
