...
<?php get_header(); ?>
	<?php if (have_posts()) : ?>
		...
		<div id="breadcrumb">
			<p><a href="<?php echo get_option('home'); ?>" title="Back to the front of the BBBBL">BBBBL</a> &raquo; <a href="<?php echo get_option('home'); ?>/teams/" title="Back to the team listing">Teams</a> &raquo; <?php the_title(); ?></p>
		</div>
			<div class="entry">
				<h2><?php the_title(); ?></h2>
<?
...
<?php
			...
			if ($oh = $wpdb->get_row($overallsql)) {
				if (NULL == $oh->OP) {
					$has_played = 0;
					print("	<div class=\"info\">\n		<p>This Team has not yet made their debut in the BBBBL. Stay tuned to see how this team develops.</p>\n	</div>\n");
				}
				else {
?>
...
<?php
			...
			if ($oteam = $wpdb->get_results($otherteamssql)) {
				print("<li>\n	<h2>Other Teams in the BBBBL</h2>\n	<ul>\n");
				foreach ($oteam as $ot) {
