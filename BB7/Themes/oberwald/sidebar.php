<?php global $the_date_title ?>
	...
	<div id="subcontent">
		<ul>
			...
			<?php } ?>
			<?php if ( is_search() ) { ?>
			<li><p>You have searched the BBBBL weblog archives for <strong>'<?php the_search_query() ?>'</strong>. If you are unable to find anything in these search results, you can try one of these links.</p></li>
			<?php } ?>
