...
20090117 - 1.1 - Changed title tag to have roster name then BBBBL
...
<title><?php wp_title(); ?> - BBBBL </title>
<?php wp_head(); ?>
<style type="text/css">
html * {
	margin:0;
...
?>
 ...
 <tr>
  ...
  <td class="tbl_value"><?php print(number_format($ti->t_tv)); ?>gp</td>
	...
	<div id="footer">
				<p>Unique content is &copy; <a href="<?php echo get_option('home'); ?>" title="Visit the homepage of the BBBBL">BBBBL</a> 2006 - present.</p>
