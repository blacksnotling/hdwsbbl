...
?>
		<div id="breadcrumb">
			<p><a href="<?php echo get_option('home'); ?>" title="Back to the front of the BBBBl">BBBBL</a> &raquo; <a href="<?php print($seasonink); ?>" title="Back to the Season listing">Seasons</a> &raquo; <?php the_title(); ?></p>
		</div>
			<div class="entry">
				<h2><?php the_title(); ?></h2>
...
<?php
				...
				if ($champions = $wpdb->get_results($championssql)) {
					print("<h3>BBBBL Championship Cup Winners this season</h3>\n");
					$zebracount = 1;
