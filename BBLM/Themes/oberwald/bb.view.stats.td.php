...
?>
		<ul>
			...
			<li><strong>Most Touchdowns scored in a Season (Player)</strong>: <?php print($mxps->VALUE); ?> (<a href="<?php print($mxps->PLAYERLink); ?>" title="See more on this Player"><?php print($mxps->PLAYER); ?></a> - <?php print($mxps->pos_name); ?> for <a href="<?php print( get_post_permalink( $mxps->WPID ) ); ?>" title="Learn more about this Team"><?php print( esc_html( get_the_title( $mxps->WPID ) ) ); ?></a> - <a href="<?php print($mxps->guid); ?>" title="Read more on this Season"><?php print($mxps->post_title); ?></a>)</li>
