...
if ( ! function_exists( 'crownstar_setup' ) ) :
	...
	function crownstar_setup() {
		 ...
		 * If you're building a theme based on crownstar, use a find and replace
		 * to change 'crownstar' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'crownstar', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'crownstar' ),
		) );
 ...
 */
function crownstar_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'crownstar_content_width', 640 );
}
add_action( 'after_setup_theme', 'crownstar_content_width', 0 );
...
function crownstar_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'crownstar' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Widgets placed here will appear on ALL pages.', 'crownstar' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Below Main Content', 'crownstar' ),
		'id'            => 'sidebar-main',
		'description'   => esc_html__( 'Widgets placed here will appear BELOW the main content (post etc) on ALL pages.', 'crownstar' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Area 1', 'crownstar' ),
		'id'            => 'footer-widget-1',
		'description'   => esc_html__( 'Appears in the footer of all pages', 'crownstar' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Area 2', 'crownstar' ),
		'id'            => 'footer-widget-2',
		'description'   => esc_html__( 'Appears in the footer of all pages', 'crownstar' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Area 3', 'crownstar' ),
		'id'            => 'footer-widget-3',
		'description'   => esc_html__( 'Appears in the footer of all pages', 'crownstar' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
function crownstar_scripts() {
	...
	wp_enqueue_script( 'crownstar-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
