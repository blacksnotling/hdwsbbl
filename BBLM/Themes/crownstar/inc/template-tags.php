...
if ( ! function_exists( 'crownstar_posted_on' ) ) :
	/**
	...
	function crownstar_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'crownstar' ),
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'crownstar' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'crownstar_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function crownstar_post_thumbnail() {
