...
?>
		<ul>
			...
			<li><strong>Most Casualties caused in a Competition (Player)</strong>: <?php print($mxpc->VALUE); ?> (<a href="<?php print($mxpc->PLAYERLink); ?>" title="See more on this Player"><?php print($mxpc->PLAYER); ?></a> - <?php print( esc_html( $mxpc->pos_name ) ); ?> for <a href="<?php print( get_post_permalink( $mxpc->WPID ) ); ?>" title="Learn more about this Team"><?php print( esc_html( get_the_title( $mxpc->WPID ) ) ); ?></a> - <?php echo bblm_get_competition_link( $mxpc->CWPID ); ?>)</li></li>
