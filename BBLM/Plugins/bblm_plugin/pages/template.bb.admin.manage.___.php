<?php
/*
*	Filename: bb.admin.manage.XYZ.php
*	Version: 0.1b
*	Description: Management page for
*/
/* -- Change History --
YYYYMMDD - 0.1a - Initial creation of file.
*/
...
<?php
		...
		print("	<p><strong>There are none of the things you are looking for. Would you like to create one?[LINK?]</strong></p>");
	}
