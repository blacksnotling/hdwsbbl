 ...
 * Fixtures Widget
 *
 * A Widget that displays a Summary of upcoming matches for the Front Page
 *
 * @class 		BBLM_Widget_FrontFixtures
...
class BBLM_Widget_FrontFixtures extends WP_Widget {

  function __construct() {

    $widget_ops = array('classname' => 'widget_bblm widget_bblm_frontwfixtures', 'description' => __( 'Front Page: Displays a list of Fixtures', 'bblm' ) );
    parent::__construct('bblm_frontwfixtures', __( 'BB:Front: Fixtures', 'bblm' ), $widget_ops);
...
?>
            <td>
              <span class="team-logo logo-odd">
                <?php echo bblm_get_team_link_logo( $m->TATWPID ); ?>
              </span>
              <span class="team-logo logo-even">
                <?php echo bblm_get_team_link_logo( $m->TBTWPID ); ?>
              </span>
...
?>
              ...
              <div class="sp-event-comp"><?php echo bblm_get_competition_link( $m->CWPID ); ?></div>
              <time class="bblm-event-date">
                <?php echo date("jS F 'y", $m->mdate ); ?>
              </time>
            </td>
          </tr>
<?php
...
// Register the widget.
function bblm_register_widget_ffix() {
  register_widget( 'BBLM_Widget_FrontFixtures' );
}
add_action( 'widgets_init', 'bblm_register_widget_ffix' );
