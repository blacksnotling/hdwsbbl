...
/**
 * Championship Cups CPT Meta-Boxes
 *
 * THe output and save functions for Meta-Boxes linked to the Championship Cups CPT
...
?>
    <select name="cup_typeddown" id="cup_typeddown">
 ...
 /**
 	...
 	*/
 	function save_meta_boxes( $post_id ) {
 		...
 		$meta['cup_type'] = ( isset( $_POST['cup_typeddown'] ) ? esc_textarea( $_POST['cup_typeddown'] ) : '' );
