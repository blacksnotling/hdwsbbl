...
/**
 * Champsionship Cups CPT admin functions
 *
 * Defines the admin functions related to the Cups CPT (edit screens, custom messages, post saving etc)
  ...
  * Constructor
  ...
  function my_edit_cup_columns( $columns ) {
  	...
  	$columns = array(
  		...
  		'title' => __( 'Title', 'bblm' ),
  		'type' => __( 'Championship Cup Type', 'bblm' ),
  	);
