<?php get_header(); ?>
	<?php if (have_posts()) : ?>
		...
		<div id="breadcrumb">
			<p><a href="<?php echo home_url(); ?>" title="Back to the front of the HDWSBBL Team News Network">Team News Network</a> &raquo; <a href="<?php echo home_url(); ?>/blog/" title="Back to the News listing">Blog</a> &raquo; <?php the_title(); ?></p>
		</div>
