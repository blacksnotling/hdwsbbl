 ...
 */
function tb2mainsite_widgets_init() {
		register_sidebar(array(
			'name'=> __( 'sidebar-posts', 'tb2mainsite' ),
			'id'=> 'sidebar-1',
			'description' => __( 'Appears at the top of the sidebar area for all pages and posts (unless the teamplate blocks it).', 'tb2mainsite' ),
...
add_action( 'widgets_init', 'tb2mainsite_widgets_init' );
