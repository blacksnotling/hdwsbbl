 ...
 *
 * To override rsvmainsite_widgets_init() in a child theme, remove the action hook and add your own
 * function tied to the init hook.
 *
 * @uses register_sidebar
 */
 function rsvmainsite_widgets_init() {
		register_sidebar(array(
			'name'=> __( 'sidebar-posts', 'rsvmainsite' ),
			'id'=> 'sidebar-1',
			'description' => __( 'Appears at the top of the sidebar area for all non-warzone pages and posts (unless the teamplate blocks it).', 'rsvmainsite' ),
...
add_action( 'widgets_init', 'rsvmainsite_widgets_init' );
